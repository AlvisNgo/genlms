...
from .views import views_login, views_announcement, views_content,views_course, views_discussion, views_notification, views_profile, api_generative, views_calender, views_course_admin
